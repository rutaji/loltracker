...
Revision ID: d79851b2b043
Revises: 
Create Date: 2026-03-14 15:11:31.336644
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('champion_name')
    )
    ...
    sa.Column('games_picked', sa.Integer(), nullable=True),
    ...
    sa.Column('championship', sa.String(), nullable=True),
